...
IndicePrimario::IndicePrimario(int mat, long offset) 
    : matricula(mat), byte_offset(offset) {}

int IndicePrimario::getMatricula() const { return matricula; }
long IndicePrimario::getByteOffset() const { return byte_offset; }
...
bool IndicePrimario::operator<(const IndicePrimario& outro) const {
